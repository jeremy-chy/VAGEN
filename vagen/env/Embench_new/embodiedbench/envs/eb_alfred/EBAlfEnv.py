...
class EBAlfEnv(gym.Env):
    ...
    """
    def __init__(self, eval_set='base', exp_name='', down_sample_ratio=1.0, selected_indexes=[], detection_box=False, resolution=500, **kwargs):
        """
    ...
    def reset(self, eval_set=None, episode_num=None):
        """
    ...
    @staticmethod
    def config_repr(self, env_config, interface_config):
        return json.dumps({'env_config': env_config, 'interface_config': interface_config}, sort_keys=True)
    
    @staticmethod
    def name_repr(self):
        return f"Episode{self._current_episode_num}"
